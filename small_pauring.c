...
#define Mprime 0x00000019  //モンゴメリ乗算の求める法を32bitとしている(Nprimeの下位３２ビット) 0xFFFCFFFD
#define NOELIPS            //ELIPSを使うか使わないか
#define pval "17"
#define oneval "9" // r&p
#define rsqval "B" // r**2%p
#define rval "20" // r = 2**5

#define MOD_WORDS 1    //BLS12-381のためこれだけ必要？32*14=448bit
#define MOD_WORDS2 2
