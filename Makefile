...
OBJS   =  main.o scalar.o mpn.o fp.o fp2.o efp.o efp2.o test_efp.o isogeny.o test_isogeny.o field_test.o create.o time.o mcl.o
HEADER = define.h scalar.h mpn.h fp.h fp2.h efp.h efp2.h test_efp.h isogeny.h test_isogeny.h field_test.h create.h time.h
