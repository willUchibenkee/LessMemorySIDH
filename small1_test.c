...
int main(void){
    ...
    Fp_add(&add, &a, &b); // c = 56026a9ebae6aba9998df54035e257f368967695146187646f353aacaccaee5cff22389a8da55aa19a9be738d84f
    printf("A+B:0x");
    Fp_print(&add);

    Fp_sub(&sub, &a, &b); // c = 56026a9ebae6aba9998df54035e257f368967695146187646f353aacaccaee5cff22389a8da55aa19a9be738d84f
    printf("A-B:0x");
    Fp_print(&sub);
